...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.uiProtocolComboBox.addItem("")
        self.gridLayout.addWidget(self.uiProtocolComboBox, 1, 1, 1, 1)
        self.uiAPIVersionComboBox = QtWidgets.QComboBox(self.tab_2)
        self.uiAPIVersionComboBox.setObjectName("uiAPIVersionComboBox")
        self.uiAPIVersionComboBox.addItem("")
        self.uiAPIVersionComboBox.addItem("")
        self.gridLayout.addWidget(self.uiAPIVersionComboBox, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.uiPasswordLineEdit, 5, 1, 1, 1)
        ...
        self.uiMenuBar.setGeometry(QtCore.QRect(0, 0, 634, 22))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.uiAPIVersionLabel.setText(_translate("MainWindow", "API version:"))
        ...
        self.uiAPIVersionComboBox.setItemText(0, _translate("MainWindow", "v2"))
        self.uiAPIVersionComboBox.setItemText(1, _translate("MainWindow", "v3"))
