...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/command_line.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.uiButtonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Apply|QtWidgets.QDialogButtonBox.Close|QtWidgets.QDialogButtonBox.Help|QtWidgets.QDialogButtonBox.Reset)
        ...
        self.uiMenuBar.setGeometry(QtCore.QRect(0, 0, 888, 42))
